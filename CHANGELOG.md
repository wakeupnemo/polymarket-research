...
- Event enrichment, websocket ingestion, stale-anchor tests, and crypto fair-value alignment remain valid but are not the immediate implementation priority.# Changelog
